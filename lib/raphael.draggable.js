 ...
 * Copyright (c) 2009 @author Matthew Ephraim
 *
...
(function() {  
  ...
  var BaseFunctions = {
    ...
    dragged: function (cb) {
      this.element.translate = (function (el, fn) {
        return function (x, y) {
          fn.call(el, x, y);
          cb.call(el, x, y);
        }
      })(this.element, this.element.translate);
    }
  };
  ...
  var DraggableExtension = function (element) {
    ...
    element.mousedown(function(event) {
      ...
      paper.draggable.current(element.draggable.parent && element.draggable.parent.draggable.enabled
        ? element.draggable.parent : element);
